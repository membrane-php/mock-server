...
use Membrane\MockServer\Matcher\MatcherFactory\Not;
...
#[UsesClass(\Membrane\MockServer\Matcher\Matcher\Not::class)]
...
final class NotTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function itCreatesMatcher(
        \Membrane\MockServer\Matcher\Matcher\Not $expected,
        array $entries,
        array $aliases,
        array $config,
    ): void {
     ...
     *     0: \Membrane\MockServer\Matcher\Matcher\Not,
    ...
    public static function provideConfigs(): \Generator
    {
        ...
        yield 'wraps another matcher with the correct config' => [
            new \Membrane\MockServer\Matcher\Matcher\Not($helloMatcher),
            [
